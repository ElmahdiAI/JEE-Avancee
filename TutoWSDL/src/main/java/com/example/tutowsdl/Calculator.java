...
public class Calculator extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("http://dneonline.com/calculator.asmx?wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://dneonline.com/calculator.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
